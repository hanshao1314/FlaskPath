import datetime  #导入获取时间的模块

# result=[]   #：接受所有的日期，需要是一个嵌套列表，列表当中嵌套的是7元列表
#
# large_month=[1,3,5,7,8,10,12]  #：当前大月的天数是31天
# small_month=[4,6,9,11]  #当前小月的天数是30天
#
# now=datetime.datetime.now()  #:获取当前的时间
# month=now.now()     #获取当前的月份
# # month=datetime.datetime.now().now()
#
# first_data=datetime.datetime(now.year,now.month,1,0,0,0)  #：获取当前的年、月、日、时、分、秒
# print(first_data)
# # print(now.weekday())
#
# if month in large_month:
